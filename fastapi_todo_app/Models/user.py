...
# openssl rand -hex 32
SECRET_KEY = "9625fd71b5b175604111df0879493db5057dda801da53dde3a0cd15e05cc0af3"
ALGORITHM = "HS256"
...
async def login_for_access_token(user_data: User,
    ...
    # statement = session.get(User, user_data.username)
    # user_info = session.exec(statement).one()
    # if not user_info:
    #     raise HTTPException(
    #         status_code=status.HTTP_401_UNAUTHORIZED,
